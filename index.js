...
acm.setCommunityAccess("public", snmp.AccessLevel.ReadWrite);
...
agent.getMib().setScalarValue('sysDescr', 'Benning');
agent.registerProvider(
  {
    name: 'vendor_name',
    type: snmp.MibProviderType.Scalar,
...
// Batterietemperatur 
// 1.3.6.1.4.1.27383.1.1.5.3.1.5.1
var tableProvider = {
  name: "ifTable",
  type: snmp.MibProviderType.Table,
  oid: "1.3.6.1.4.1.27383.1.1.5.3.1",
  tableColumns: [
    {
      number: 5,
      name: "ifIndex",
  ...
  handler: function ifTable(mibRequest) {
    mib.setTableSingleCell("ifTable", 5, [1], Math.floor(Math.random() * 101));
    mibRequest.done();
  }
};
...
// add Batterietemperatur
mib.addTableRow("ifTable", [1]);
